...
public class StudentServices {
	...
	static {
		try {
			ArrayList<Student> todaysBirthDay = dao.todaysBirthDay();
			if(todaysBirthDay.isEmpty())
				System.out.println("\n\n\n\t\t\t\t\t\t\tNo Student having Birthday today");
			else {
				System.out.println("\n\n\n\t\t\t\t\t\t\t" + todaysBirthDay.stream().count() + " Students Having Birthday Today");
				for(Student s : todaysBirthDay) {
					System.out.println("\n\t\t\t\t\t\t\t" + s.getName() + "\n\t\t\t\t\t\t\t" + s.getPhone() + "\n\t\t\t\t\t\t\t" + s.getDob() +"\n");
				}
			}
	...
	public static void main(String[] args) {
		...
		try {
			while (true) {
				...
				System.out.println("\t|   11.    |  Update Student's DOB     |");
				System.out.println("\t|   12.    |  Update Complete Student  |");
				System.out.println("\t****************************************");
				System.out.println("\t|   13.    |  Delete Student by ID     |");
				System.out.println("\t****************************************");
				...
				case 1: // Save
					...
					System.out.println("Date of Birth strictly follow the (yyyy-MM-dd) format: ");
					std.setDob(sc.next());
					...
					if (count != 0)
						...
						System.out.println("Enter Marks between 1 to 100 only & correct Phone Number !!!");
					else
				...
				case 11: // Update Student's DOB
					System.out.println("Enter ID of Student & Updated Date of Birth strictly follow the (yyyy-MM-dd) format: ");
					System.out.println(dao.updateStudentDate(sc.nextInt(), sc.next()));
					break;
				// ------------------------------------------------------------------------------------------------------------

				case 12: // Update Complete Student
					std = new Student();
					...
					System.out.println("Updated Date of Birth strictly follow the (yyyy-MM-dd) format: ");
					std.setDob(sc.next());
